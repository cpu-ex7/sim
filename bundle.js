...
},{"bs-platform/lib/js/curry.js":25,"bs-platform/lib/js/lexing.js":28,"bs-platform/lib/js/pervasives.js":30}],36:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.9.2, PLEASE EDIT WITH CARE
'use strict';
...
},{"bs-platform/lib/js/array.js":2,"bs-platform/lib/js/block.js":4,"bs-platform/lib/js/caml_builtin_exceptions.js":8,"bs-platform/lib/js/caml_exceptions.js":10,"bs-platform/lib/js/curry.js":25,"bs-platform/lib/js/pervasives.js":30,"bs-platform/lib/js/printf.js":31}],37:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.9.2, PLEASE EDIT WITH CARE
'use strict';
...
},{"bs-platform/lib/js/block.js":4,"bs-platform/lib/js/caml_format.js":12,"bs-platform/lib/js/curry.js":25,"bs-platform/lib/js/lexing.js":28,"bs-platform/lib/js/pervasives.js":30}],38:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.9.2, PLEASE EDIT WITH CARE
'use strict';
...
},{"bs-platform/lib/js/list.js":29}],39:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.9.2, PLEASE EDIT WITH CARE
'use strict';
...
function run() {
  var program = Sim.compile(input_area["textContent"]);
  var core = Sim.empty_core(/* () */0);
  fetch(core);
  Sim.exec_all(/* Some */[core], program);
  writeback(core);
  return /* () */0;
}
...
},{"../sim.js":42,"./jsExt.js":40,"bs-platform/lib/js/arrayLabels.js":3,"bs-platform/lib/js/caml_array.js":7,"bs-platform/lib/js/caml_format.js":12}],40:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.9.2, PLEASE EDIT WITH CARE
'use strict';
...
},{"bs-platform/lib/js/js.js":26}],41:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.9.2, PLEASE EDIT WITH CARE
'use strict';
...
function _menhir_run2(_menhir_env, _menhir_stack, _menhir_s, _v) {
  ...
  var _v$1;
  try {
    _v$1 = /* Dest */Block.__(2, [List.assoc(_v, Label.g_label[0])]);
  }
  catch (exn){
    if (exn === Caml_builtin_exceptions.not_found) {
...
},{"./label.js":34,"./opSyntax.js":38,"bs-platform/lib/js/array.js":2,"bs-platform/lib/js/block.js":4,"bs-platform/lib/js/caml_builtin_exceptions.js":8,"bs-platform/lib/js/caml_exceptions.js":10,"bs-platform/lib/js/curry.js":25,"bs-platform/lib/js/list.js":29,"bs-platform/lib/js/pervasives.js":30,"bs-platform/lib/js/printf.js":31}],42:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.9.2, PLEASE EDIT WITH CARE
'use strict';
...
function compile_file(filename) {
  var label = label_parse_file(filename);
  Label.update_label(label);
  var filename$1 = filename;
  return Parser.toplevel(Lexer.main, Lexing.from_channel(Pervasives.open_in(filename$1)));
}

function compile(str) {
  var label = LabelParser.toplevel(LabelLexer.main, Lexing.from_string(str));
  Label.update_label(label);
...
function exec_oneline(core, line) {
  switch (line[0]) {
    case 0 : 
        var core$1 = core;
        var operands = line[1];
                ...
                switch (match$1.tag | 0) {
                  case 0 : 
                      ...
                      switch (match$2.tag | 0) {
                        case 0 : 
                            rset(core$1, match[0], Caml_array.caml_array_get(core$1[/* reg */1], match$1[0]) + Caml_array.caml_array_get(core$1[/* reg */1], match$2[0]) | 0);
                            return incr(core$1);
                        case 1 : 
                        case 2 : 
                            return Pervasives.failwith("add: bad operands");
    ...
    case 1 : 
        var core$2 = core;
        var operands$1 = line[1];
        if (operands$1.length !== 3) {
          return Pervasives.failwith("addi: bad operands");
        } else {
          var match$3 = operands$1[0];
          switch (match$3.tag | 0) {
            case 0 : 
                var match$4 = operands$1[1];
                switch (match$4.tag | 0) {
                  case 0 : 
                      var match$5 = operands$1[2];
                      switch (match$5.tag | 0) {
                        case 1 : 
                            rset(core$2, match$3[0], Caml_array.caml_array_get(core$2[/* reg */1], match$4[0]) + match$5[0] | 0);
                            return incr(core$2);
                        case 0 : 
                        case 2 : 
                            return Pervasives.failwith("addi: bad operands");
    ...
    case 2 : 
        var core$3 = core;
        var operands$2 = line[1];
        if (operands$2.length !== 3) {
          return Pervasives.failwith("addi: bad operands");
        } else {
          var match$6 = operands$2[0];
          switch (match$6.tag | 0) {
            case 0 : 
                var match$7 = operands$2[1];
                switch (match$7.tag | 0) {
                  case 0 : 
                      var match$8 = operands$2[2];
                      switch (match$8.tag | 0) {
                        case 1 : 
                            rset(core$3, match$6[0], Caml_array.caml_array_get(core$3[/* reg */1], match$7[0]) < match$8[0] ? 1 : 0);
                            return incr(core$3);
                        case 0 : 
                        case 2 : 
                            return Pervasives.failwith("addi: bad operands");
    ...
    case 3 : 
        var core$4 = core;
        var operands$3 = line[1];
        if (operands$3.length !== 1) {
          return Pervasives.failwith("jump: bad operands");
        } else {
          var match$9 = operands$3[0];
          switch (match$9.tag | 0) {
            case 0 : 
            case 1 : 
                return Pervasives.failwith("jump: bad operands");
            case 2 : 
                core$4[/* pc */0][0] = match$9[0];
                return /* () */0;
    ...
    case 5 : 
        var core$5 = core;
        var operands$4 = line[1];
        if (operands$4.length !== 3) {
          return Pervasives.failwith("bne: bad operands");
        } else {
          var match$10 = operands$4[0];
          switch (match$10.tag | 0) {
            case 0 : 
                var match$11 = operands$4[1];
                switch (match$11.tag | 0) {
                  case 0 : 
                      var match$12 = operands$4[2];
                      switch (match$12.tag | 0) {
                        case 0 : 
                        case 1 : 
                            return Pervasives.failwith("bne: bad operands");
                        case 2 : 
                            core$5[/* pc */0][0] = Caml_array.caml_array_get(core$5[/* reg */1], match$10[0]) !== Caml_array.caml_array_get(core$5[/* reg */1], match$11[0]) ? match$12[0] : core$5[/* pc */0][0] + 1 | 0;
                            return /* () */0;
...
function exec_all($staropt$star, lines) {
  ...
  try {
    while(true) {
      exec_oneline(core, Caml_array.caml_array_get(lines, core[/* pc */0][0]));
    };
  }
  catch (exn){
    if (exn !== ExecutionEnd) {
...
function exec_func(filename, funcname, arg) {
  var lines = compile_file(filename);
  var start = List.assoc(funcname, Label.g_label[0]);
  var core_000 = /* pc */[0];
...
},{"./label.js":34,"./labelLexer.js":35,"./labelParser.js":36,"./lexer.js":37,"./parser.js":41,"bs-platform/lib/js/caml_array.js":7,"bs-platform/lib/js/caml_exceptions.js":10,"bs-platform/lib/js/lexing.js":28,"bs-platform/lib/js/list.js":29,"bs-platform/lib/js/pervasives.js":30}]},{},[39]);
